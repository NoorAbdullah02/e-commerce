...
DATABASE_URL = os.getenv('DATABASE_URL', 'postgresql://neondb_owner:npg_DfVBIpQ49ezT@ep-ancient-hill-ah1vkorr-pooler.c-3.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require')
...
GEMINI_API_KEY = os.getenv('GEMINI_API_KEY', 'AIzaSyDoMVhmBOUfFfZ60qGj6TO1F8yyE0hdbBQ')
