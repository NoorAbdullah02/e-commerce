...
# stripe secret test key - Get from environment variable or settings
stripe.api_key = os.getenv('STRIPE_TEST_SECRET_KEY') or getattr(settings, 'STRIPE_TEST_SECRET_KEY', 'sk_test_your_key_here')
